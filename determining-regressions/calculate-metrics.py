...
This is it. This is the big kahuna.
This is the behemoth of confusing code that calculates the
indicator metrics. It prints the results out in csv format

This takes like 20 hours to run on my machine :(
There is probably a way to make it faster, like preprocessing
dynamic profile data out of the database into csv files - but
I didnt do that! So oh well.
